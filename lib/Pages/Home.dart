...
import 'package:grocery_store/Pages/GroceryCart.dart';
import 'package:grocery_store/Providers/GroceryProvider.dart';
import 'package:grocery_store/Widgets/GroceryList.dart';

const backgroundColor = Color(0xFFF6F5F2);
const carBarHeigh = 100.0;
...
class _GroceryStoreHomeState extends State<GroceryStoreHome> 
{
  ...
  double _getTopForWhitePanel( GroceryState state, Size size )
  {
    ...
    {
      return -carBarHeigh + kToolbarHeight;
    }else if( state == GroceryState.cart ){

      return -(size.height - kToolbarHeight - carBarHeigh / 2);
    }
    return 0.0;
  }
  ...
  double _getTopForBlackPanel( GroceryState state, Size size){
    ...
    if( state == GroceryState.normal ){
      ...
      return size.height - carBarHeigh;

    }else if( state == GroceryState.cart ){

      return carBarHeigh / 2;
                                                      ...
                                                      (index) => Padding(
                                                        ...
                                                        child: Stack(
                                                          children: [
                                                            ...
                                                            Hero(
                                                                tag: 'list_${bloc.cart[index].product.nombre}details',
                                                                child: CircleAvatar(
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          SizedBox(width: 10),
          Expanded(
            child: Text('Fruits and vegetable', style: TextStyle(color: Colors.black))
          ),
          IconButton(
